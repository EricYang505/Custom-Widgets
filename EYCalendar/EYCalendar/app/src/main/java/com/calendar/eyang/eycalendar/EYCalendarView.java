...
public class EYCalendarView extends FrameLayout {
    ...
    public interface OnDateChangeListener {
         ...
         */
         public void onSelectedDayChange(EYCalendarView view, int year, int month, int dayOfMonth);
          ...
          */
         public void onFocusedMonthChange(EYCalendarView view, int newYear, int newMonth);
    }

    public EYCalendarView(Context context) {
        this(context, null);
    }

    public EYCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public EYCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        monthPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				if(mOnDateChangeListener!=null) {
					...
					mOnDateChangeListener.onFocusedMonthChange(EYCalendarView.this, newYear, newMonth);
    ...
    private OnSelectDayListener mOnSelectDayListener = new OnSelectDayListener() {
		...
		public void onSelectedDayChange(Calendar day) {
			...
			if(mOnDateChangeListener!=null) {
				mOnDateChangeListener.onSelectedDayChange(EYCalendarView.this, day.get(Calendar.YEAR) , day.get(Calendar.MONTH),
    ...
    private  class MonthView extends FrameLayout{
        ...
        private class WeekView extends View {
             ...
             *            {@link EYCalendarView#getMinDate()}.
