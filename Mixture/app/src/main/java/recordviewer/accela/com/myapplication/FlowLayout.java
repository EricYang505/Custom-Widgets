...
/**
 * Created by eyang on 11/21/16.
 */
public class FlowLayout extends ViewGroup{
    private static final String TAG = "zxt/FlowLayout";
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (ta!=null) {
            textColor = ta.getColor(R.styleable.FlowLayout_colorText, getResources().getColor(R.color.colorAccent));
            space = ta.getDimension(R.styleable.FlowLayout_space, 0);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthMeasure = View.MeasureSpec.getSize(widthMeasureSpec);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (curLeft + childWidth > rightLimit ) {
                ...
                viewT = curTop + params.topMargin + (int)space;
                viewR = viewL + childW;
                viewB = viewT + childH;
